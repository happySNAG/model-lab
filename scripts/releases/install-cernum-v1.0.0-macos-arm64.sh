#!/bin/bash
# Cernum v1.0.0 — Apple Silicon Mac (arm64): install or upgrade, verify the build, spend nothing.
#
...
EXPECTED_SHA="e0e4c1ab477f862f66cc1646a53053eea43d4b4146a3f045dbdeb8d53ca1f35e"
...
[ "$ARCH" = "arm64" ] || die "this is a $ARCH machine; this installs the Apple Silicon build.
         For an Intel Mac use install-cernum-v${VERSION}-macos-x64.sh."
