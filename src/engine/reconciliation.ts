 ...
 *
 * WHY A THIRD LIST RATHER THAN A LINE APPENDED TO EITHER OF THE OTHER TWO. `REQUESTED_COHORT` is the
...
export const AUTHORIZED_COHORT: RequestedConfiguration[] = [
  ...REQUESTED_COHORT, ...CERNUM_V2_ADDITIONS, ...FREE_OPENCODE_POOL_ADDITIONS,
];
