...
function metricsRow(metrics: FrontierCandidateMetrics): FrontierMetricsRow {
  ...
  return {
    ...
    measuredAttemptCount: metrics.measuredAttemptCount,
    notMeasuredAttemptCount: metrics.notMeasuredAttemptCount,
    successfulTaskCount: metrics.successfulTaskCount,
    successfulTaskRateMilli: value('successful-task rate (end to end, over every attempt)', metrics.successfulTaskRateMilli),
    scoredTaskRateMilli: value('scored-task rate (over the attempts a model answered)', metrics.scoredTaskRateMilli),
