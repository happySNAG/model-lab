...
const { createIndexes, indexTask, markClosed, idsFor, idsLabelled, openCountFor } = require('./indexes.js');
...
function reassignTask(board, id, owner) {
  throw new Error('reassignTask is not implemented yet');
}

/** Replace a task's labels. */
function relabelTask(board, id, labels) {
  throw new Error('relabelTask is not implemented yet');
}
